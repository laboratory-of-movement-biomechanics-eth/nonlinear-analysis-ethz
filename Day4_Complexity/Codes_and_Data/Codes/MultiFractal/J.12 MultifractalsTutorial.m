...
%% TITLE: ETH Zurich 2023 Multifractal Tutorial
% DATE: June, 2023
% AUTHOR: Aaron D. Likens & Anaelle Charles
% EMAIL: alikens@unomaha.edu

% DESCRIPTION: 
% This file contains example code for conducting multifractal anlaysis of
% human movement data. The code examples coincides with Part II of the
% lecture slides.
